...
from usecases.atendimento.dto.post_atendimentos_dto.post_atendimento_input_dto import PostAtendimentoInputDto
from usecases.atendimento.dto.put_atendimentos_dto.put_atendimento_input_dto import PutAtendimentoInputDto
